                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: textstyle.subtitle.copyWith(
                              color: colors.background, fontSize: 13.sp,fontWeight: FontWeight.bold),
                        ),
                      )),
                ),
                // count of viewers
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            username!,
                            style:
                                textstyle.maintitle.copyWith(fontSize: 17.sp),
                          ),
                          Text(
                            countrycity!,
                            style: textstyle.subtitle.copyWith(fontSize: 7.sp),
                          ),
                        ],
                      ),
                    ),
